...
class FurtiveLocalizedPreset extends Preset
{
    /** @var Command */
    protected $command;
    ...
    {
        copy(__DIR__.'/../furtive-stubs/bootstrap/webpack.mix.js', base_path('webpack.mix.js'));
    }
    ...
    protected static function updateSass()
    {
        ...
        copy(__DIR__.'/../furtive-stubs/bootstrap/_variables.scss', resource_path('sass/_variables.scss'));
        copy(__DIR__.'/../furtive-stubs/bootstrap/app.scss', resource_path('sass/app.scss'));
    }
    ...
    {
        copy(__DIR__.'/../furtive-stubs/bootstrap/bootstrap.js', resource_path('js/bootstrap.js'));
        copy(__DIR__.'/../furtive-stubs/bootstrap/app.js', resource_path('js/app.js'));
    }
    ...
    protected function scaffoldAuth()
    {
        ...
        tap(new Filesystem(), function ($filesystem) {
            $filesystem->copyDirectory(__DIR__.'/../furtive-stubs/auth-localized', resource_path('views/auth'));
            $filesystem->copyDirectory(__DIR__.'/../furtive-stubs/layouts-localized', resource_path('views/layouts'));
            $filesystem->copy(__DIR__.'/../furtive-stubs/home-localized.blade.php', resource_path('views/home.blade.php'));
