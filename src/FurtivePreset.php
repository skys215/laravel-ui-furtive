...
class FurtivePreset extends Preset
{
    /** @var Command */
    protected $command;
    ...
    protected function scaffoldAuth()
    {
        ...
        tap(new Filesystem(), function ($filesystem) {
            $filesystem->copyDirectory(__DIR__.'/../furtive-stubs/auth', resource_path('views/auth'));
            $filesystem->copyDirectory(__DIR__.'/../furtive-stubs/layouts', resource_path('views/layouts'));
            $filesystem->copy(__DIR__.'/../furtive-stubs/home.blade.php', resource_path('views/home.blade.php'));
